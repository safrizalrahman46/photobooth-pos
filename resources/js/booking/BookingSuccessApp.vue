...
<template>
    <div class="min-h-[calc(100vh-4rem)] bg-[#F8FAFC]">
        <div class="pointer-events-none absolute inset-0 overflow-hidden">
            <div class="absolute top-10 right-10 h-48 w-48 rounded-full bg-[#2563EB]/5"></div>
        ...
        <main class="relative mx-auto max-w-lg px-4 py-8">
                ...
                <div class="space-y-3 p-6">
                    ...
                    <div class="space-y-1.5 border-t border-dashed border-slate-300 pt-3">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="text-[#1F2937]">{{ formatRupiah(props.booking.total_amount) }}</span>
                        </div>

                        <div class="flex justify-between text-sm">
                            <span class="text-gray-500">Dibayar</span>
                            <span class="text-[#1F2937]">{{ formatRupiah(props.booking.paid_amount) }}</span>
                        </div>
            ...
            <div
                class="grid gap-3 transition-all duration-500 ease-out sm:grid-cols-2"
                :class="isReady ? 'translate-y-0 opacity-100' : 'translate-y-3 opacity-0'"
