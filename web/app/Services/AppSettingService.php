    ...
    private function defaultAdminUiConfig(): array
    {
        return [
            ...
            'nav_items' => [
                ...
                ['id' => 'cashier-settlements', 'label' => 'Setoran Kasir', 'icon' => 'receipt', 'href' => '/admin/cashier-settlements', 'group' => 'operations'],
            ...
            'topbar_meta' => [
                ...
                'cashier-settlements' => ['title' => 'Setoran Kasir', 'subtitle' => 'Cocokkan setoran cash per sesi kasir'],
