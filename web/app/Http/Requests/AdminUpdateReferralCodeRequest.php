...
class AdminUpdateReferralCodeRequest extends FormRequest
{
    ...
    {
        $referralCode = $this->route('referralCode');
        $referralCodeId = $referralCode instanceof ReferralCode ? $referralCode->id : null;

        return [
            'code' => ['required', 'string', 'max:40', 'regex:/^[A-Za-z0-9_-]+$/', Rule::unique('referral_codes', 'code')->ignore($referralCodeId)],
