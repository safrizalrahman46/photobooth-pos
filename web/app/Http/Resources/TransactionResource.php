...
class TransactionResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'customer_name' => (string) ($this->booking?->customer_name ?? $this->queueTicket?->customer_name ?? ''),
            'customer_phone' => (string) ($this->booking?->customer_phone ?? $this->queueTicket?->customer_phone ?? ''),
