...
class UbahMetodeDialogResult {
  ...
  const UbahMetodeDialogResult({required this.method, required this.reason});
}
...
class _UbahMetodeDialogState extends State<UbahMetodeDialog> {
  ...
  static const _reasonOptions = [
    'Koreksi Human Error Kasir',
    'Pembayaran Diganti (Refund & Ganti Metode)',
    'Permintaan Pelanggan',
    'Lainnya...',
  ];

  bool get _canSubmit => _method != widget.currentMethod
      && (_isCustomReason
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 20),
                    _label('ALASAN PERUBAHAN (WAJIB)'),
                    const SizedBox(height: 8),
                    ..._reasonOptions.map((option) {
                      final isSelected = !_isCustomReason && _selectedReason == option;
                      final isLast = option == _reasonOptions.last;
                      return Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: isSelected || (isLast && _isCustomReason)
                              ...
                              border: Border.all(
                                ...
                                width: isSelected || (isLast && _isCustomReason) ? 2 : 1,
                              ),
                            ),
                            child: Row(
                              children: [
                                Icon(
                                  isSelected || (isLast && _isCustomReason)
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 13,
                                    fontWeight: isSelected || (isLast && _isCustomReason)
                                        ? FontWeight.w700
                                        : FontWeight.w500,
                                    color: isSelected || (isLast && _isCustomReason)
                                        ? const Color(0xFF1E293B)
