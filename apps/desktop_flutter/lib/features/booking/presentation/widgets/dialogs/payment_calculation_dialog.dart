...
class PaymentCalculationDialog extends StatefulWidget {
  ...
  @override
  State<PaymentCalculationDialog> createState() => _PaymentCalculationDialogState();
}
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _InfoRow(label: 'Pelanggan', value: widget.controller.customerName),
                    _InfoRow(label: 'Paket', value: '${widget.controller.selectedPackage.name} (${widget.controller.selectedPackage.duration})'),
                    _InfoRow(label: 'Metode', value: widget.controller.selectedPayment),
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final addon = widget.controller.selectedAddons[index];
                            return Padding(
                          ...
                          if (!isQris) ...[
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  _formatPrice(_changeAmount < 0 ? 0 : _changeAmount),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: GridView.count(
                        ...
                        children: [
                          for (var i = 1; i <= 9; i++) _NumButton(val: '$i', onTap: () => _onNumberPress('$i')),
                          _NumButton(val: '000', onTap: () => _onNumberPress('000')),
                          _NumButton(val: '0', onTap: () => _onNumberPress('0')),
                          _NumButton(
                            val: 'X',
                            onTap: _onBackspace,
                            isAction: true,
