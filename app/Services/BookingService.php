    ...
    public function create(array $payload): Booking
    {
        return DB::transaction(function () use ($payload): Booking {
            ...
            $booking = Booking::query()->create([
                ...
                'payment_gateway' => $payload['payment_gateway'] ?? 'manual_qr_bri',
                'payment_reference' => $payload['payment_reference'] ?? null,
                'payment_payload' => $payload['payment_payload'] ?? null,
                'transfer_proof_path' => $payload['transfer_proof_path'] ?? null,
                'transfer_proof_uploaded_at' => $payload['transfer_proof_uploaded_at'] ?? null,
                'addons' => $addons,
